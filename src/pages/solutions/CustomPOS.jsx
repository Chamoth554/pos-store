import { Code2, Check, ArrowUpRight, Puzzle, Layers, Settings2 } from 'lucide-react'
...
const highlights = [
  {
    ...
    description: 'Every module is designed around how your business actually operates, not a generic template.',
  },
  {
    icon: Settings2,
    title: 'Custom Features',
    description: 'From loyalty programs to industry-specific billing rules, we build exactly what you need.',
  },
  {
    icon: Layers,
    title: 'Business-Specific Modules',
    description: 'Add accounting, HR, or inventory modules tailored to your industry.',
  },
  {
    icon: Code2,
    title: 'Scalable Architecture',
    description: 'Software that grows with you, from a single outlet to a multi-branch operation.',
  },
]

const features = [
  'Requirements gathering & workflow analysis',
  'Custom-built modules for your exact needs',
  'Integration with existing hardware & software',
  'Dedicated support during and after development',
  'Scalable architecture for future growth',
  'Full ownership of your custom system',
]
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-[var(--text-secondary)] sm:text-base">
            Tailored POS software built around your unique business workflow, industry
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-5 rounded-2xl border border-white/[0.07] bg-white/[0.025] px-6 py-5 backdrop-blur-xl sm:flex-row sm:px-7">
          <div>
            <p className="text-sm font-semibold text-[var(--text-primary)]">
              Have a workflow that needs a custom build?
            </p>
            <p className="mt-1 text-xs text-[var(--text-secondary)]">
              Talk to our team and we'll scope out your requirements.
            </p>
          </div>
          <Link
            to="/contact"
